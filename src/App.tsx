...
import { Heart, BellRing, Link2, Settings as SettingsIcon, LogOut, Volume2, VolumeX, Palette, Globe, Save, Phone, PhoneOff, Mic, MicOff, Video, VideoOff, History, Clock, MessageCircle, Send, X, Camera, HeartPulse, ScreenShare, Brush, Moon, CalendarHeart, AlarmClock, PenTool, Eraser } from "lucide-react";
